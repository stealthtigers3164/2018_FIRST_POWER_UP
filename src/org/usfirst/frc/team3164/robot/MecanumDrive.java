...
public class MecanumDrive extends RobotDriveBase {
  ...
  public void driveCartesian(double ySpeed, double xSpeed, double zRotation, double speedBoost, double speedDecrease) {
    driveCartesian(ySpeed, xSpeed, zRotation, 0.0, speedBoost, speedDecrease);
  }
   ...
   */
  @SuppressWarnings("ParameterName")
  public void driveCartesian(double ySpeed, double xSpeed, double zRotation, double gyroAngle, double speedBoost, double speedDecrease) {
    if (!m_reported) {
    ...
    wheelSpeeds[MotorType.kFrontLeft.value] *= m_maxOutput;
    wheelSpeeds[MotorType.kFrontRight.value] *= m_maxOutput;
    wheelSpeeds[MotorType.kRearLeft.value] *= m_maxOutput;
    wheelSpeeds[MotorType.kRearRight.value] *= m_maxOutput;
    
//	int frontLeftSign = (wheelSpeeds[MotorType.kFrontLeft.value] > 0) ? 1 : -1;
//	int frontRightSign = (wheelSpeeds[MotorType.kFrontRight.value] > 0) ? 1 : -1;
//	int backLeftSign = (wheelSpeeds[MotorType.kRearLeft.value] > 0) ? 1 : -1;
//	int backRightSign = (wheelSpeeds[MotorType.kRearRight.value] > 0) ? 1 : -1;
//	
//	wheelSpeeds[MotorType.kFrontLeft.value] += speedBoost * frontLeftSign;
//	wheelSpeeds[MotorType.kFrontLeft.value] -= speedDecrease * frontLeftSign;
//	wheelSpeeds[MotorType.kFrontRight.value] += speedBoost * frontRightSign;
//	wheelSpeeds[MotorType.kFrontRight.value] -= speedDecrease * frontRightSign;
//	wheelSpeeds[MotorType.kRearLeft.value] += speedBoost * backLeftSign;
//	wheelSpeeds[MotorType.kRearLeft.value] -= speedDecrease * backLeftSign;
//	wheelSpeeds[MotorType.kRearRight.value] += speedBoost * backRightSign;
//	wheelSpeeds[MotorType.kRearRight.value] -= speedDecrease * backRightSign;
